#' Whit's [ggplot2] theme
#'
#' Color palettes that whit likes.
#'
#' @export
#' @param palette Palette name.
whit_color_pal <- function(palette = "categorical") {
  palette_list <- palette_whit
  ...
  function(n) {
    ...
    if (n > 8) {
      ...
      stop(
        paste(
          "Error: whitrthemes allows for a max of 8 colors. Your code asked for",
          n,
          "colors.",
...
scale_color_discrete <- function(...) {
  ggplot2::discrete_scale(
    aesthetics = "colour",
    scale_name = "whit",
    palette = whit_color_pal("categorical"),
    ...
  )
}
...
scale_color_gradientn <- function(...,
                                  colours = c("#003f5c", "#255571", "#406b88", "#59829e", "#739bb6", "#8db3ce",
                                              "#a7cde6", "#c2e7ff"),
                                  colors = c("#003f5c", "#255571", "#406b88", "#59829e", "#739bb6", "#8db3ce",
                                             "#a7cde6", "#c2e7ff"),
                                  values = NULL,
                                  space = "Lab",
                                  na.value = "grey50",
...
scale_fill_ordinal <- function(...) {
  ggplot2::discrete_scale(
    aesthetics = "fill",
    scale_name = "whit",
    palette = whit_color_pal("sequential"),
    ...
  )
}
