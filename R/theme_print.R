...
#'
#' \code{theme_print} provides a [ggplot2] formatted theme.
#'
...
theme_print <- function(base_size = 8.5, base_family = "Arial",
                             base_line_size = 0.5,
                             base_rect_size = 0.5) {
  ...
  ggplot2::theme(
    ...
    axis.text = ggplot2::element_text(size = base_size * 1.3),
    ...
    axis.title = ggplot2::element_text(size = base_size * 1.3, face = "bold"),
