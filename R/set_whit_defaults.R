...
#'
#' \code{set_whit_defaults} provides a [ggplot2] custom formatted theme.
#'
...
set_whit_defaults <- function(
  ...
  ggplot2::update_geom_defaults("bar", list(fill = "#003f5c"))
  ggplot2::update_geom_defaults("col", list(fill = "#003f5c"))
  ggplot2::update_geom_defaults("point", list(colour = "#003f5c", size = 3))
  ggplot2::update_geom_defaults("line", list(colour = "#003f5c", size = 1))
  ggplot2::update_geom_defaults("step", list(colour = "#003f5c", size = 1))
  ggplot2::update_geom_defaults("path", list(colour = "#003f5c", size = 1))
  ...
  ggplot2::update_stat_defaults("count", list(fill = "#003f5c"))
